...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Apr 30, 2022 at 06:45 PM
...
--
ALTER TABLE `idea`
  MODIFY `ideaId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `qac`
--
ALTER TABLE `qac`
  MODIFY `qacId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `qam`
--
ALTER TABLE `qam`
  MODIFY `qamId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `rating_info`
--
ALTER TABLE `rating_info`
  MODIFY `rating_info_id` int(11) NOT NULL AUTO_INCREMENT;
